    ...
    sections={[
      {
        ...
        component: (
          <div>
            <Paragraph>
              I have always wanted to create a custom color scheme. Last year I finally took the plunge with help from <Anchor href='https://twitter.com/AC_Design'>Adam Christiansen</Anchor> as the designer, and <Anchor href='http://merrickchristensen.com/'>Merrick Christensen</Anchor> as a fellow developer. We built <Anchor href='/projects/nova'>Nova - A color scheme for modern web development</Anchor>.
            </Paragraph>
          </div>
        ),
      },
      {
        ...
        component: (
          <div>
            <Paragraph>
              We had a set of goals for the project
            </Paragraph>
            <Image 
            ...
            />
            <Paragraph>
              We especially wanted each color to have a dedicated meaning so that the color scheme was functional
            </Paragraph>
            <Image 
      ...
      },
      {
        ...
        component: (
          <div>
            <Paragraph>
              I'd like to thank the following wonderful people for their help with Nova
            </Paragraph>
            <List
              items={[
                <span><Anchor href='http://merrickchristensen.com/'>Merrick Christensen</Anchor> for his help building the Nova plugins and constant mentoring and support</span>,
                <span><Anchor href='https://twitter.com/AC_Design'>Adam Christiansen</Anchor> for his great design skills and helping me get the project started</span>,
                <span><Anchor href='http://alexlafroscia.com/'>Alex LaFroscia</Anchor> for his fantastic pull requests to the project</span>,
              ]}
            />
          </div>
        ),
