    ...
    sections={[
        ...
        component: (
          <div>
            <Paragraph>
              ...
              settings can stop someone from viewing porn or other unwholesome
              media if they want to view it. The first step is desire to avoid
              it and to have good things to replace it with. This comes from
              understanding why it’s harmful. Internal desire is the most
              important thing that truly keeps porn and other crude media out of
              my life.
            </Paragraph>
          </div>
        ),
      },
      {
        ...
        component: (
          <div>
            <Paragraph>
              Although filters can’t stop someone who wants to view porn, they
              can be helpful for avoiding accidentally viewing porn. The filter
              options below can be helpful.
            </Paragraph>
          </div>
        ),
      },
      {
        ...
        component: (
          <div>
            <Paragraph>
              You can add a filter to your router; this is the most useful
            ...
            <Paragraph>
              ...
              servers instead of the default ones on your router. The default
              ones in the instructions block phishing, but “Family Shield”
              blocks both phishing and porn.
            </Paragraph>
            <Image
            ...
            />
            <Paragraph>
              One thing to note is that, although a router filter is helpful for
              wifi and ethernet connections, it doesn't affect devices using
              cellular data (not on the network from your router).
            </Paragraph>
          </div>
        ),
      },
          ...
          <div>
            ...
            <Paragraph>
              ...
              <Anchor href="https://support.google.com/websearch/answer/186669?hl=en">
                SafeSearch VIP needs to be enabled on your router which only
                certain routers support
        ...
        component: (
          <div>
            <Paragraph>
              ...
              are apps available on the apps store, but relying on the “Router”
              option above is a good start.
            </Paragraph>
          </div>
        ),
      },
