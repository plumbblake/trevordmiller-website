    ...
    sections={[
      {
        ...
        component: (
          <div>
            <Paragraph>
              This is my current opinion. The list will be updated as I learn
              more and as the community and tools evolve. These options are also
              just a baseline for the typical types of projects I work on, but
              each project has its own unique needs where different options
              would be a better fit. Everything has tradeoffs and there is no
              "one true stack" of programming tools. Let's all be kind - avoid
              the hostile holy wars about "tool A destroys tool B"; we are all
              in this together and everything has pros and cons. I hope this
              list with my research and experience can be helpful in some way,
              but this list is by no means the "best" or "right" way to do
              things ;)
            </Paragraph>
          </div>
        ),
        ...
        component: (
          <Teaser
            ...
            links={[
              {
                description:
                  'Watch a video course on publishing your own npm packages',
                href:
...

      {
        ...
        component: (
          <div>
            <Paragraph>
              Phew! That is a lot of tooling. Note that not all tools are
              necessary when starting a project, but become more useful as the
              code and team size grow. The nice thing is that most of these
              tools don't require much effort after they are set up. Here is an
              example project with these tools in place so you can see how they
              fit together.
            </Paragraph>
            <Anchor href="https://github.com/trevordmiller/example-web-app">
              <Button>View example project</Button>
            </Anchor>
            <Paragraph>
              I wrote a script that I use to scaffold new projects like this
              with all the tools mentioned in this post. I find it helps me
              create more projects without worrying about project setup, and
              then when my preferences change I just update the script for
              future projects to get the updates as well.
            </Paragraph>
            <Anchor href="https://github.com/trevordmiller/shell-scripts/blob/master/scripts/create-js-project">
              <Button>View the script</Button>
            </Anchor>
          </div>
        ),
      },

      {
        ...
        component: (
          <div>
            <Paragraph>
              There are some underlying principles with each of these tooling
              choices:
            </Paragraph>
            <List
              items={[
                <span>
                  I generally favor lightweight options that do one thing well
                  and compose together with other things, rather than large
                  "all-in-one" type solutions because it is easier to upgrade
                  and swap out pieces as things change.
                </span>,
                <span>
                  I try to stay more in "the middle" of the constant pendulum of
                  technology options rather than swinging to extremes, because
                  the pendulum always swings back.
                </span>,
                <span>
                  I do lean a bit towards the Functional Programming camp
                  because I've found that these patterns have helped me write
                  code that has less bugs and is easier to change without
                  breaking other things.
                </span>,
                <span>
                  I favor composition over inheritance because it is easier for
                  my brain to understand.
                </span>,
                <span>
                  I use open source options wherever possible to avoid
                  proprietary lock-in and support the community.
                </span>,
                <span>
                  I favor battle-tested, more widely used options to avoid large
                  amounts of early-adoption bugs.
                </span>,
                <span>
                  I generally favor minimal configuration over strict setups
                  because I believe that strictness deters innovation and adds
                  extra complexity.
                </span>,
                <span>
                  Many of these options are not needed to start out, or possibly
                  ever. I like to start with only what is needed and only add
                  other tools if they solve a problem that arises.
                </span>,
              ]}
            />
          </div>
...

      {
        ...
        component: (
          <div>
            <Paragraph>
              Programming is a deep field. There are so many languages, tools,
              and options out there that making decisions on them can be
              intimidating. Although these are my current preferences, all of
              this is subject to change as I learn and progress and the
              community changes. I'm happy to use other tools and try new things
              as well. I strive to keep an open mind and always keep learning
              and hope the same for our community; let's all strive to lift and
              help each other and learn together, rather than getting caught up
              in antagonistic tech discussions and dogmatic attitudes. I am
              extremely grateful that I get to be a software engineer working in
              the front-end; yes, it can be a little complex and fast-paced at
              times, but I enjoy the challenge and chance to continually learn
              and grow!
            </Paragraph>
          </div>
        ),
